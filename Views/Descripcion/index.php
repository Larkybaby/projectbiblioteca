...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <!--<a href="index.php?controllers=DescripcionController&action=crear" class="btn btn-primary"> Agregar Descripcion</a><!--este es el boton para agregar--><!--cambiar--> 
</div>
...
<table class="table table-striped table-hover">
    ...
    <tbody>
        ...
        <tr><!--traemos los datos  las cositas asi $ son variables aqui va--> 
            ...
            <td><?= htmlspecialchars($Descripcion['titulo_libro']) ?></td><!--cambiar nombre tabla y campo--> 
            <td><?= $Descripcion['id_prestamo'] ?></td>
            <td><?= $Descripcion['nota'] ?></td>
            <td><!--cambiar--> 
                <a href="index.php?controllers=DescripcionController&action=editar&id=<?= $Descripcion['id_descripcion'] ?>"  
                   class="btn btn-warning btn-sm"> Editar</a><!--boton para editar-->
                <a href="index.php?controllers=DescripcionController&action=eliminar&id=<?= $Descripcion['id_descripcion'] ?>"  
